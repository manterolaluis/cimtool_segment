...
strEstadisticas = {strcat('GSM:', num2str(GSM)),...
    strcat('Sztajzel - Homogeneous:',strHomogenea),...
    strcat('Sztajzel - Heterogeneous:',strHeterogenea),...
    ...
    strcat('# measurements:',num2str(mediciones)),...
    strcat('Diameter px Media:',num2str(diametroPxMedia)),...
    strcat('Diameter px Std:',num2str(diametroPxStd)),...
    strcat('Diameter px Median:',num2str(diametroPxMedian))...
    strcat('Diameter Media:',num2str(diametroMedia),'mm'),...
    strcat('Diameter Std:',num2str(diametroStd)),...
    strcat('Diameter Median:',num2str(diametroMedian),'mm'),...
    strcat('-----------------------------'),...
